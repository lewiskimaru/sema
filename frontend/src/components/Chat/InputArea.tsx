...
import { ArrowUp, ChevronDown, Languages, MessageSquare, Upload, X } from 'lucide-react';
...
export default function InputArea({ onSendMessage, isCentered = false }: InputAreaProps) {
  ...
  return (
    <div className={`${isCentered ? 'p-0' : 'p-4'} ${isCentered ? 'input-area-container' : ''}`}>
      <div className={`w-full ${isCentered ? '' : 'max-w-[800px] mx-auto px-4 sm:px-0'}`}>
        <div
